...
<section class="dash-shell" data-admin-root hidden id="main">
  <div class="container">
    <div class="dash-grid">
      ...
      <aside class="dash-sidebar" id="admin-drawer" data-dash-sidebar aria-label="Admin console navigation">
      ...
      <main class="dash-main">
        ...
        <button class="dash-drawer-trigger" type="button" data-dash-drawer-open aria-controls="admin-drawer" aria-expanded="false">
          ...
          <span class="dash-drawer-trigger__label" data-dash-drawer-current>Admin menu</span>
