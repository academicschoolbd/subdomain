...
function settings_defaults(): array
{
    return [
        ...
        // string falls back to the platform default (#0f766e teal). The
        // dark-mode variant is auto-derived (lightened 30%) when the
        // dark hex is left blank, but admins can pin a custom dark hex
        // too if they want absolute control over both themes.
        'theme_primary_hex'      => '',
        'theme_primary_dark_hex' => '',
    ];
}
