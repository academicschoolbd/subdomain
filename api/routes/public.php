...
function route_public_settings(array $CONFIG): void
{
    ...
    send_json([
        ...
        'platform' => [
            ...
            'show_recent_domains' => ($platform['show_recent_domains'] ?? '1') === '1',
            'show_stats_section'          => ($platform['show_stats_section'] ?? '1') === '1',
            'show_brands_section'         => ($platform['show_brands_section'] ?? '1') === '1',
            'show_how_it_works_section'   => ($platform['show_how_it_works_section'] ?? '1') === '1',
            'show_bengali_usecase_section'=> ($platform['show_bengali_usecase_section'] ?? '1') === '1',
            'show_whatsapp_section'       => ($platform['show_whatsapp_section'] ?? '1') === '1',
            'show_faq_section'            => ($platform['show_faq_section'] ?? '1') === '1',
            'show_cta_section'            => ($platform['show_cta_section'] ?? '1') === '1',
        ...
        // v4.5 — admin-controllable home / brand theme color. The frontend
        // can use these to live-update CSS variables when the admin changes
        // them from the settings panel without a page reload.
        'theme' => [
            'primary'      => theme_load_colors($CONFIG)['primary'],
            'primary_dark' => theme_load_colors($CONFIG)['primary_dark'],
        ],
