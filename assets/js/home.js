...
(function () {
  ...
  /* ------------------------------------------------------------------ */
  /* v4.5 — Two-tile public stats. Pending / rejected counts are now    */
  /* admin-only and live in the moderation dashboard, not the homepage. */
  /* ------------------------------------------------------------------ */
  const liveTiles = {
  ...
  // v4.5 — fast-feedback first refresh: hit the network ASAP after paint
  // (was 1.5s) so a freshly-deployed homepage feels live immediately,
  // then settle into the regular 30 s poll.
